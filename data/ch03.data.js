"use strict";
/* 챕터 3 데이터 — "스택과 큐의 응용" = 2장(B) (강의 3장 후반 · 제작 규약 v1.1 · 주간 루프 공용 러너 사용)
   챕터 2에서 분리(감수: 한 주 분량 과다) — 괄호 검사 / 표기법·우선순위 / 후위식 평가 / 중위→후위 변환 + 미로. */
const CH03 = {
  meta: { id:"ch03", week:2, part:"B", title:"스택과 큐의 응용", sub:"스택, 계산기가 되다", nextTeaser:"리스트", nextHint:'교수님이 "다음 칸의 주소를 쪽지에 적어 두는 공책" 얘기를 하던데요… 공책 페이지가 왜 흩어져 있는 거죠?' },
  ...
  cpl: {
    "study-A":"2장(B) · 월 — 괄호 검사 자습","trial-A":"2장(B) · 월 — 괄호 검사 시련","il-A":"2장(B) · 월요일 밤",
    "study-B":"2장(B) · 화 — 표기법 자습","trial-B":"2장(B) · 화 — 표기법 시련","il-B":"2장(B) · 화요일 밤",
    "tutor":"2장(B) · 수 — 과외",
    "study-C":"2장(B) · 목 — 후위식 평가 자습","trial-C":"2장(B) · 목 — 후위식 평가 시련","il-C":"2장(B) · 목요일 밤",
    "study-D":"2장(B) · 금 — 변환 자습","trial-D":"2장(B) · 금 — 변환 시련","maze":"2장(B) · 금요일 밤 — 미로",
    "saturday":"2장(B) · 토 — 보충/A+","sunday":"2장(B) · 월 — 쪽지시험"
  },
