...
const CH06 = {
  ...
  interludes: {
    ...
    B: [
      {who:"도윤", face:"doyun", text:'(문자) 쌤, 엄마 심부름으로 마트 갔는데요. 계산대는 온 순서대로 계산해 주잖아요. 근데 물건 찾을 땐 한 통로를 끝까지 훑고, 없으면 되돌아 나와서 다음 통로로 갔거든요. 오늘 수업에서 교수님이 「트리를 읽는 순서가 여러 가지」라고 했는데, 왠지 그 얘기랑 닿아 있는 것 같아서요.'},
