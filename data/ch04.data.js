...
const CH04 = {
  ...
  interludes: {
    A: [
      ...
      {who:"나", face:"me-proud", text:'(답장) 그게 정확히 오늘 밤 내가 공부한 <b>배열의 삽입</b>이다. 좌석이 붙어 있으니 중간에 끼려면 뒤가 전부 밀리는 거야. 내일은 안 밀리는 방법을 배운다 — 각자 흩어져 앉는 대신, 다음 사람이 어느 자리에 있는지 쪽지를 들고 있는 방식.'}
    ],
    B: [
