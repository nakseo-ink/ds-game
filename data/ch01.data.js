...
const CH01 = {
  meta: { id:"ch01", week:2, title:"배열과 구조", sub:"나란한 칸, 묶인 칸", nextTeaser:"스택이랑 큐", nextHint:'교수님이 "접시 쌓기"라던데… 그게 뭔 소리예요?' },
  ...
  study: {
    A: { day:"월요일", label:"유닛 A", title:"배열 (array)", doneLabel:"시련 시작 — 주소 계산 ▶", beats:[
      ...
      {who:"book", say:'"삭제도 마찬가지 — 구멍을 메우려 당긴다, O(n). 정리: <b>접근 O(1), 탐색 O(n), 중간 삽입·삭제 O(n)</b>. 칸이 붙어 있지 않아도 순서를 유지할 수는 없을까? — 5주차에서."'},
    ...
    D: { day:"금요일", label:"유닛 D", title:"다항식 — 현실의 정보를 어떻게 저장할까", doneLabel:"padd 트레이스 시작 ▶", beats:[
      ...
      {say:'오리엔테이션 헌책방 여백에 스쳐 갔던 그 메모구나 — "구현은 미루고 연산부터 생각하기." 이제 정식 이름으로 기억하자. <b>추상 자료형, ADT.</b>', mood:"proud"},
